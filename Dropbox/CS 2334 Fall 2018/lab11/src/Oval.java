...
public class Oval extends Shape
{
    ...
    public Oval(Point pointCenter, int diameter1, int diameter2, Color color, boolean filled)
    {
        ...
        location[1] = new Point(pointCenter.x - diameter1, pointCenter.y + diameter2);
        location[2] = new Point(pointCenter.x + diameter1, pointCenter.y - diameter2);
        location[3] = new Point(pointCenter.x - diameter2 , pointCenter.y + diameter1);
        location[4] = new Point(pointCenter.x + diameter2, pointCenter.y - diameter1);
    ...
    public void draw(Graphics graphics)
    {
        ...
        if ( isFilled())
        {
            graphics.fillOval(location[0].x - diameter1, location[0].y - diameter2, diameter1, diameter2);
        }
        else
        {
            graphics.drawOval(location[0].x - diameter1, location[0].y - diameter2, diameter1, diameter2);
        }
